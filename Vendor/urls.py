...
from .views import Vendor_Profile,Vendor_Profile_Specific,Purchase_Order,Purchase_Order_Specific,Purchase_Order_Acknowledge,Purchase_Order_Completed,Vendor_Performance,Vendor_Historical_Performance
...
urlpatterns = [
    ...
    path('vendors/<int:pk>/history_performance',Vendor_Historical_Performance.as_view(),name='Vendor-Performance-History'),
